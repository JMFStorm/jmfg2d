...
void set_window_size(s32 width_px, s32 height_px) {
        ...
        load_font(debug_font_ptr, get_debug_font_size(), "G:\\projects\\game\\jmfg2d.win32\\resources\\fonts\\Inter-Regular.ttf");
...
int WINAPI WinMain(HINSTANCE instance, HINSTANCE prev_instance, LPSTR cmd_line, int cmd_show) {
        ...
        test_texture_id = load_image_to_texture("G:\\projects\\game\\jmfg2d.win32\\resources\\images\\bricks_reclaimed.png");
